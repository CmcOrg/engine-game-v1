...
public abstract class AbstractNettyTcpProtoBufServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        try {
            ...
            if (ctx.channel().attr(GAME_USER_ID_KEY).get() == null) {
                ...
                handlerSecurityMessage(msg, ctx.channel(), longArr -> {
     ...
     * 处理：身份认证的消息
     */
    public abstract void handlerSecurityMessage(Object msg, Channel channel, VoidFunc<Long> voidFunc);
